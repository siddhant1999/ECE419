...
public class TestUtility {
    ...
    public static void putXgetY(KVStore client, double decPUT, int totalRange, String cacheType) throws Exception {
        ...
        System.out.println(
                cacheType + " Total Run Time of " + percentPUT + "% put, " + Integer.toString(100 - percentPUT) +
    ...
    public static LinkedList<KVStore> startNClient(int n) {
        ...
        for (int i = 0; i < n; i++) {
            clients.add(new KVStore("0.0.0.0", i + 20000));
        }
        return clients;
    }
    ...
    public static boolean checkLLContainsKV(LinkedList<KeyValue> ll, KeyValue kv) {
        for (KeyValue llKV : ll) {
            if (llKV.getKey().equals(kv.getKey()) && llKV.getValue().equals(kv.getValue()))
                return true;
        }
        return false;
    }
    ...
    public static void printAllData(TreeMap<String, TreeMap<String, LinkedList<KeyValue>>> allData,
            TreeMap<String, IECSNode> serversMetaData,
            String funcName) {
    ...
    public static boolean inAllDataLL(TreeMap<String, TreeMap<String, LinkedList<KeyValue>>> allData, String hostServer,
            String replicatedServer, KeyValue kv) {
        try {
